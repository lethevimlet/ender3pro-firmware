...
#define STRING_CONFIG_H_AUTHOR "(Lethe, Ender-3)" // Who made the changes.
...
#define CUSTOM_MACHINE_NAME "Lethe Printer"
 ...
 *     O-- FRONT --+
 */
#define NOZZLE_TO_PROBE_OFFSET { -42, -10, -6.50 }
